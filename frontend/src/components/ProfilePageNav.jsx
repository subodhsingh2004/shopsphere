        ...
        <div className='h-full w-auto flex items-center flex-col md:flex-row'>
            <div className='md:h-[500px] w-[280px] dark:bg-[#191919] flex flex-col items-center border border-gray-200 dark:border-[#414141] rounded-2xl'>
                ...
                <div className='w-full flex-col flex-1 p-6 space-y-4'>
                    ...
                    <NavLink to={`/profile/${userDetails._id}/wishlist`} className={({ isActive }) => `flex items-center gap-2 cursor-pointer text-sm ${isActive ? "text-[#3772ff] font-medium" : "text-[#707070]"} `}>                        <FavoriteBorderOutlinedIcon />
                        Wishlist
                    </NavLink>
