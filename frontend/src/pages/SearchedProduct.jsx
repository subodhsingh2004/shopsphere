                    ...
                    <div className='bg-white h-auto dark:bg-black w-[85%] p-4 pb-10'>
...

                        {
                            filterProducts.length > 0 ?
                                ...
                                </div> : <div className='flex h-full flex-col items-center justify-center space-y-2'>
                                    <span className='text-[#707070] text-xl font-medium'>No products found!</span>
                                    <p className='w-[400px] text-sm text-center leading-4'>We couldn't find any products matching your search. <br /> Try adjusting your filters or search terms</p>
                                </div>
                        }
